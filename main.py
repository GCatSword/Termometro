...
class Termometro():
    ...
    def convert(self, grados, toUnidad):
        resuntado = 0
        if toUnidad == 'F':
...
class Selector():
    ...
    def __init__(self, unidad = 'C'):
        self.__customes = []
        self.__customes.append(pygame.image.load("images/termo3.png"))
        self.__customes.append(pygame.image.load("images/termo4.png"))
        ...
        while True:
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    temperatura = self.termometro.convert(grados, nuevaUnidad)
                    self.entrada.value(temperatura) 
                    
            #Pintar fondo pantalla
            self.__screen.fill((244, 236, 203))
              
            #pintar el termometro en su posición)        
            ...
            pygame.draw.rect(self.__screen, (255, 255, 255), text[0])#pintar rectangulo blanco con posicioón y tamaño
            self.__screen.blit(text[1], self.entrada.pos())# pintar foto texto
